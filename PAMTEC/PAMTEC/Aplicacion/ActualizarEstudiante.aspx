<%@ Page Title="" Language="C#" MasterPageFile="~/Aplicacion/PrincipalAdministrador.Master" AutoEventWireup="true" CodeBehind="ActualizarEstudiante.aspx.cs" Inherits="PAMTEC.Aplicacion.ActualizarEstudiante" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="from1" runat="server">
<asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4"  style="z-index: 1; width: 650px; height: 203px; position: absolute; top: 362px; left: 513px; font-family: 'Century Gothic'; font-size: medium;" OnSelectedIndexChanged="Editar" >
 ...
 <asp:Panel ID="Panel3" runat="server" Style="z-index: 1; width: 1054px; height: 101px; position: absolute; top: 185px; left: 363px; font-family: 'Century Gothic'; font-size: large">
  ...
  <asp:Panel ID="Panel1" runat="server" Style="z-index: 1; width: 1101px; height: 500px; position: absolute; top: 254px; left: 366px; color: #333333; border-style: outset; border-width: 6px; margin-left: 4px; margin-top: 10px" Visible="False">
        ...
        <asp:TextBox ID="TextBoxBuscaNombre" runat="server" style="left: 550px; top: 278px"></asp:TextBox>
        <asp:Button ID="ButtonBuscar" runat="server" Text="Ver" OnClick="ButtonBuscar_Click" style="z-index: 1; position: absolute; top: 276px; left: 792px" />
        <br />
        <br />
        <br />
        <br />
