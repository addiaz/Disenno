<%@ Page Title="" Language="C#" MasterPageFile="~/Aplicacion/PrincipalTutor.Master" AutoEventWireup="true" CodeBehind="AgregarEstudianteTutor.aspx.cs" Inherits="PAMTEC.Aplicacion.AgregarEstudianteTutor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <link href="../css/bootstrap.min.css" rel="stylesheet">
    ...
    <form  id="form1" runat="server">
        ...
        <br />
        <asp:Panel ID="Panel1" runat="server" Style="z-index: 1; width: 1101px; height: 500px; position: absolute; top: 242px; left: 319px; color: #333333; border-style: outset; border-width: 6px; margin-left: 4px; margin-top: 10px">
            ...
            <textarea id="TextArea1" runat="server" cols="20" name="S1" rows="2" style="left: 814px; top: 127px"></textarea></asp:Panel>
        <br />
        <br />
        <br />
        <br />
        ...
        <strong>
            <asp:Panel ID="Panel3" runat="server" Style="z-index: 1; width: 1054px; height: 66px; position: absolute; top: 177px; left: 318px; font-family: 'Century Gothic'; font-size: large">
                <div >
