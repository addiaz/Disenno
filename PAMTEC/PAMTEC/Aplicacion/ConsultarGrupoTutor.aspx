<%@ Page Title="" Language="C#" MasterPageFile="~/Aplicacion/PrincipalTutor.Master" AutoEventWireup="true" CodeBehind="ConsultarGrupoTutor.aspx.cs" Inherits="PAMTEC.Aplicacion.ConsultarGrupoTutor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

    <form id="form1" runat="server">
        <br />
        <asp:Panel ID="Panel1" runat="server" style="z-index: 1; width: 716px; height: 340px; position: absolute; top: 264px; left: 455px; color: #333333; border-style: outset; border-width: 6px; margin-left: 4px; margin-top: 10px">
            ...
            <asp:Label ID="LabelMensaje" runat="server" style="z-index: 1; position: absolute; top: 233px; left: 377px; color: #FF0000" Text="Label" Visible="False"></asp:Label>
        </asp:Panel>
        <br />
        <br />
        <br />
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" style="z-index: 1; width: 656px; height: 127px; position: absolute; top: 630px; left: 319px; font-family: 'Century Gothic'; font-size: medium; margin-left: 0px" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
            ...
            <tr>
                <td>
                    <img alt="" src="../Images/grupo.jpg" style="width: 168px; height: 161px; z-index: 1; position: absolute; top: 337px; left: 1212px" /></td>
            </tr>
            </table>
        <br />
        <br />
